...
import com.example.trabalho_de_mobile.databinding.ActivitySucoDeAbacaxiBinding

class SucoDeAbacaxiActivity : AppCompatActivity() {

    private lateinit var binding:ActivitySucoDeAbacaxiBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_suco_de_abacaxi)
        ...
        binding = ActivitySucoDeAbacaxiBinding.inflate(layoutInflater)
