...
import com.example.trabalho_de_mobile.databinding.ActivitySucoDeMelanciaBinding

class SucoDeMelanciaActivity : AppCompatActivity() {

    private lateinit var binding:ActivitySucoDeMelanciaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_suco_de_melancia)
        ...
        binding = ActivitySucoDeMelanciaBinding.inflate(layoutInflater)
