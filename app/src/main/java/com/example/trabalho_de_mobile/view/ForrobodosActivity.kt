...
import com.example.trabalho_de_mobile.databinding.ActivityForrobodosBinding

class ForrobodosActivity : AppCompatActivity() {

    private lateinit var binding: ActivityForrobodosBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_forrobodos)
        ...
        binding = ActivityForrobodosBinding.inflate(layoutInflater)
