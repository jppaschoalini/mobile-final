...
import com.example.trabalho_de_mobile.databinding.ActivityPistacheBinding

class PistacheActivity : AppCompatActivity() {

    private lateinit var binding: ActivityPistacheBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_pistache)
        ...
        binding = ActivityPistacheBinding.inflate(layoutInflater)
