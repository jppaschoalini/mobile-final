...
import com.example.trabalho_de_mobile.databinding.ActivitySucoDeAcerolaBinding

class SucoDeAcerolaActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySucoDeAcerolaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_suco_de_acerola)
        ...
        binding = ActivitySucoDeAcerolaBinding.inflate(layoutInflater)
