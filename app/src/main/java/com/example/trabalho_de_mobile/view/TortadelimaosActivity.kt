...
import com.example.trabalho_de_mobile.databinding.ActivityTortadelimaosBinding

class TortadelimaosActivity : AppCompatActivity() {

    private lateinit var binding:ActivityTortadelimaosBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_tortadelimaos)
        ...
        binding = ActivityTortadelimaosBinding.inflate(layoutInflater)
